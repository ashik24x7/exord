        ...
        <div class="content-wrapper container">
            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-1 compose_form">
                    ...
                    @endif
                    <form role="form" method="post" action="{{ url('/admin/heading') }}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                        <div class="row">
                            <div class="form-group">
                                <div class="col-md-12">
                                    <input type="text" placeholder="" class="form-control" name="heading" value="{{ old('heading')}}" required="required">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <textarea name="content" placeholder="" class="form-control" id="content" cols="30" rows="10"></textarea>
