                                ...
                                <div class="col-md-3">
                                    <div class="widget-box clearfix">
                                        <div>
                                            ...
                                            <h2><i class="fa fa-plus pull-right"></i></h2>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="widget-box clearfix">
                                        <div>
                                            <h4>Unpaid Bills</h4>
                                            <h2><i class="fa fa-tasks pull-right"></i></h2>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="widget-box clearfix">
                                        <div>
                                            ...
                                            <h2><i class="fa fa-usd pull-right"></i></h2>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
...
@section('script')
        ...
        <script src="../dashboard/js/flot/jquery.flot.tooltip.min.js"></script>
        <script src="../dashboard/js/flot/jquery.flot.resize.js"></script>
        <script src="../dashboard/js/flot/jquery.flot.pie.js"></script>
        <script src="../dashboard/js/chartjs/Chart.min.js"></script>
        
        <script src="../dashboard/js/morris_chart/raphael-2.1.0.min.js"></script>
        <script src="../dashboard/js/morris_chart/morris.js"></script>
